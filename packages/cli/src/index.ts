...
const COMPONENT_REGISTRY: Record<string, ComponentMeta> = {
  ...
  "falling-text": { title: "Falling Text", description: "Matter.js-powered word physics text where words break apart, fall, bounce, and can be dragged with the mouse.", category: "text", dependencies: ["matter-js", "clsx", "tailwind-merge"] },
  "split-text": { title: "Split Text", description: "GSAP SplitText-powered reveal animation with character/word/line splitting and staggered entrance.", category: "text", dependencies: ["gsap", "@gsap/react", "clsx", "tailwind-merge"] },
  "blur-text": { title: "Blur Text", description: "Viewport-triggered blur reveal animation for words or letters with configurable direction and stagger.", category: "text", dependencies: ["framer-motion", "clsx", "tailwind-merge"] },
  "shiny-text": { title: "Shiny Text", description: "Animated shine sweep effect across text with speed, direction, spread, and yoyo controls.", category: "text", dependencies: ["framer-motion", "clsx", "tailwind-merge"] },
  "fuzzy-text": { title: "Fuzzy Text", description: "Canvas-powered text distortion effect with hover-reactive intensity, glitch mode, and directional fuzzing.", category: "text", dependencies: ["clsx", "tailwind-merge"] },
  "scroll-reveal": { title: "Scroll Reveal", description: "GSAP ScrollTrigger text reveal with progressive word opacity, optional blur, and subtle rotational unwind.", category: "text", dependencies: ["gsap", "clsx", "tailwind-merge"] },
  "variable-proximity": { title: "Variable Proximity", description: "Mouse-proximity variable font interpolation per character with configurable radius and falloff curves.", category: "text", dependencies: ["framer-motion", "clsx", "tailwind-merge"] },
  ...
  "circular-text": { title: "Circular Text", description: "Wraps text around a rotating circular path with optional hover-to-spin behavior and center label.", category: "text", dependencies: ["clsx", "tailwind-merge"] },
  ...
  "silk": { title: "Silk", description: "WebGL silk fabric background with configurable speed, scale, color, and noise intensity.", category: "visual", dependencies: ["@react-three/fiber", "three"] },
  "grid-motion": { title: "Grid Motion", description: "Animated grid of images/content with randomized motion and hover interactions.", category: "visual", dependencies: ["framer-motion", "clsx", "tailwind-merge"] },
  "orb": { title: "Orb", description: "WebGL glowing orb background with customizable hue and hover-reactive animation.", category: "visual", dependencies: ["ogl"] },
  "liquid-chrome": { title: "Liquid Chrome", description: "Chrome-like liquid metal background with reflective distortion and mouse-reactive movement.", category: "visual", dependencies: ["ogl"] },
  "balatro": { title: "Balatro", description: "Psychedelic swirling background effect inspired by the Balatro card game aesthetic.", category: "visual", dependencies: ["ogl"] },
  "dither": { title: "Dither", description: "Dithered wave background with configurable colors, wave amplitude, and Three.js postprocessing.", category: "visual", dependencies: ["@react-three/fiber", "@react-three/postprocessing", "postprocessing", "three"] },
  "dot-grid": { title: "Dot Grid", description: "Interactive dot grid background with GSAP-powered hover trail and directional movement.", category: "visual", dependencies: ["gsap"] },
  "beams": { title: "Beams", description: "Volumetric light beam background with Three.js, customizable beam count, colors, and speed.", category: "visual", dependencies: ["@react-three/fiber", "@react-three/drei", "three"] },
  "dark-veil": { title: "Dark Veil", description: "Shadowy layered veil background with OGL-powered animated gradients and depth.", category: "visual", dependencies: ["ogl"] },
  "light-rays": { title: "Light Rays", description: "Dynamic light ray background with configurable color, speed, and ray count.", category: "visual", dependencies: ["ogl"] },
  "prism": { title: "Prism", description: "Rainbow prismatic refraction background with light dispersion and chromatic effects.", category: "visual", dependencies: ["ogl"] },
  "gradient-blinds": { title: "Gradient Blinds", description: "Animated gradient blinds background with configurable colors, angle, and transition speed.", category: "visual", dependencies: ["ogl"] },
  "grainient": { title: "Grainient", description: "Grainy gradient background with film-grain noise overlay and smooth color transitions.", category: "visual", dependencies: ["ogl"] },
  "pixel-blast": { title: "Pixel Blast", description: "Explosive pixel dissolution background with Three.js particle system and postprocessing.", category: "visual", dependencies: ["three", "postprocessing"] },
  "liquid-ether": { title: "Liquid Ether", description: "Ethereal liquid background with flowing color gradients and smooth WebGL animation.", category: "visual", dependencies: ["three"] },
  "color-bends": { title: "Color Bends", description: "Curved color band background with smooth bending gradients and animated transitions.", category: "visual", dependencies: ["three"] },
  "light-pillar": { title: "Light Pillar", description: "Vertical light pillar background with glowing beams and atmospheric scattering.", category: "visual", dependencies: ["three"] },
  "antigravity": { title: "Antigravity", description: "Floating particle system with anti-gravity physics, 3D depth, and mouse interaction.", category: "visual", dependencies: ["@react-three/fiber", "three"] },
  "click-spark": { title: "Click Spark", description: "Spark burst effect on click with radiating particles and configurable colors.", category: "visual", dependencies: [] },
  "laser-flow": { title: "Laser Flow", description: "Animated laser beam flow background with neon glow and configurable beam paths.", category: "visual", dependencies: ["three"] },
  "ribbons": { title: "Ribbons", description: "Flowing 3D ribbon animation with OGL-powered smooth curves and color gradients.", category: "visual", dependencies: ["ogl"] },
  "splash-cursor": { title: "Splash Cursor", description: "Fluid splash effect that follows cursor movement with ripple and wave dynamics.", category: "visual", dependencies: [] },
};
