...
usage: `import FileUpload from "@/app/components/ui/file-upload"
...
playground: {
  controls: [
    { name: "accept", label: "Accept", type: "text", default: "image/*" },
    { name: "maxSize", label: "Max Size (bytes)", type: "number", default: 5242880 },
    { name: "multiple", label: "Multiple", type: "boolean", default: true },
    { name: "maxFiles", label: "Max Files", type: "number", default: 10 },
    { name: "disabled", label: "Disabled", type: "boolean", default: false },
  ],
},
component: () => import("@/app/components/ui/file-upload"),
demo: () => import("@/app/components/demos/file-upload-demo"),
};
