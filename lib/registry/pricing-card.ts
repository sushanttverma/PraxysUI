...
usage: `import PricingCard from "@/app/components/ui/pricing-card"
...
props: [
  {
    ...
    type: "string",
    default: "—",
    description: "Plan name displayed at the top.",
  },
  {
    name: "price",
    type: "string",
  ...
  },
  {
    ...
    type: "string",
    default: "'/mo'",
    description: "Billing period suffix.",
  },
  {
    name: "features",
    type: "string[]",
  ...
  },
  {
    ...
    type: "boolean",
    default: "false",
    description: "Show the popular badge and highlight border.",
  },
  {
    name: "onCtaClick",
    type: "() => void",
...
playground: {
  controls: [
    { name: "title", label: "Title", type: "text", default: "Pro" },
    { name: "price", label: "Price", type: "text", default: "$29" },
    { name: "period", label: "Period", type: "text", default: "/mo" },
    { name: "cta", label: "CTA Text", type: "text", default: "Upgrade to Pro" },
    { name: "popular", label: "Popular", type: "boolean", default: true },
  ],
  defaults: {
    features: ["Unlimited Projects", "100 GB Storage", "Priority Support", "API Access"],
  },
},
component: () => import("@/app/components/ui/pricing-card"),
demo: () => import("@/app/components/demos/pricing-card-demo"),
};
