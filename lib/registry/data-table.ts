...
usage: `import DataTable from "@/app/components/ui/data-table"
...
props: [
  {
    ...
    type: "Column<T>[]",
    default: "[]",
    description: "Array of column definitions with key, header, optional render function, and sortable flag.",
  },
  {
    name: "data",
    type: "T[]",
...
playground: {
  controls: [
    { name: "striped", label: "Striped", type: "boolean", default: true },
    { name: "hoverable", label: "Hoverable", type: "boolean", default: true },
  ],
  defaults: {
    columns: [
      { key: "name", header: "Name", sortable: true },
...
component: () => import("@/app/components/ui/data-table"),
demo: () => import("@/app/components/demos/data-table-demo"),
};
