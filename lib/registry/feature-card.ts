...
usage: `import FeatureCard from "@/app/components/ui/feature-card"
...
props: [
  {
    ...
    default: "—",
    description: "Icon element displayed at the top of the card.",
  },
  {
    name: "title",
    type: "string",
...
playground: {
  controls: [
    { name: "title", label: "Title", type: "text", default: "Blazing Fast" },
    { name: "description", label: "Description", type: "text", default: "Optimized for performance with lazy loading and code splitting." },
  ],
  defaults: {
    icon: "⚡",
  },
},
component: () => import("@/app/components/ui/feature-card"),
demo: () => import("@/app/components/demos/feature-card-demo"),
};
