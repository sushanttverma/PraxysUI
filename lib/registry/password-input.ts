...
usage: `import PasswordInput from "@/app/components/ui/password-input"
...
playground: {
  controls: [
    ...
    { name: "placeholder", label: "Placeholder", type: "text", default: "Enter password" },
  ],
  defaults: {
  },
},
component: () => import("@/app/components/ui/password-input"),
demo: () => import("@/app/components/demos/password-input-demo"),
};
