...
usage: `import Sheet from "@/app/components/ui/sheet"
  ...
  return (
    <>
      ...
      <Sheet open={open} onClose={() => setOpen(false)} title="Settings">
        <p className="text-sm text-text-faint">Sheet content goes here.</p>
      </Sheet>
    </>
  )
}`,
props: [
  ...
  },
  {
    ...
    type: "() => void",
    default: "—",
    description: "Callback to close the sheet.",
  },
  {
    name: "side",
...
playground: {
  controls: [
    { name: "side", label: "Side", type: "select", default: "right", options: ["left", "right", "top", "bottom"] },
    { name: "title", label: "Title", type: "text", default: "Sheet Title" },
  ],
},
component: () => import("@/app/components/ui/sheet"),
demo: () => import("@/app/components/demos/sheet-demo"),
};
