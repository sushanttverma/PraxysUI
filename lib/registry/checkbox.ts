...
usage: `import Checkbox from "@/app/components/ui/checkbox"
...
props: [
  ...
  },
  {
    ...
    default: "undefined",
    description: "Callback when the checkbox is toggled.",
  },
  {
    name: "label",
    type: "string",
...
playground: {
  controls: [
    ...
    { name: "label", label: "Label", type: "text", default: "Accept terms" },
    { name: "disabled", label: "Disabled", type: "boolean", default: false },
    { name: "error", label: "Error", type: "text", default: "" },
  ],
},
component: () => import("@/app/components/ui/checkbox"),
demo: () => import("@/app/components/demos/checkbox-demo"),
};
