...
usage: `import Avatar from "@/app/components/ui/avatar"
...
props: [
  ...
  },
  {
    ...
    type: "string",
    default: "''",
    description: "Alt text for the image, also used to derive fallback initials.",
  },
  {
    name: "fallback",
    type: "string",
    default: "undefined",
    description: "Explicit initials to display when no image is available.",
  },
  {
    name: "size",
    type: "'sm' | 'md' | 'lg' | 'xl'",
  ...
  },
  {
    ...
    default: "undefined",
    description: "Status indicator dot with color and optional pulse animation.",
  },
  {
    name: "className",
    type: "string",
...
playground: {
  controls: [
    { name: "size", label: "Size", type: "select", default: "md", options: ["sm", "md", "lg", "xl"] },
    { name: "status", label: "Status", type: "select", default: "online", options: ["online", "offline", "busy", "away"] },
    { name: "fallback", label: "Fallback", type: "text", default: "AB" },
  ],
},
component: () => import("@/app/components/ui/avatar"),
demo: () => import("@/app/components/demos/avatar-demo"),
};
