...
usage: `import Folder from '@/app/components/ui/folder'
...
props: [
  {
    ...
    type: "string",
    default: "'#E04E2D'",
    description: "Primary folder color (hex).",
  },
  {
    name: "size",
    type: "number",
    default: "1",
    description: "Scale multiplier for the folder dimensions.",
  },
  {
    name: "items",
    type: "Array<React.ReactNode>",
    default: "[]",
    description: "Content for up to 3 inner papers.",
  },
  {
    name: "className",
    type: "string",
...
component: () => import("@/app/components/ui/folder"),
demo: () => import("@/app/components/demos/folder-demo"),
};
