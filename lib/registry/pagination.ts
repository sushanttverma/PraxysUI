...
usage: `import Pagination from "@/app/components/ui/pagination"
...
playground: {
  controls: [
    { name: "currentPage", label: "Current Page", type: "number", default: 1, min: 1, max: 20, step: 1 },
    { name: "totalPages", label: "Total Pages", type: "number", default: 20, min: 1, max: 100, step: 1 },
    { name: "siblingCount", label: "Sibling Count", type: "number", default: 1, min: 0, max: 3, step: 1 },
    { name: "size", label: "Size", type: "select", default: "md", options: ["sm", "md"] },
  ],
},
component: () => import("@/app/components/ui/pagination"),
demo: () => import("@/app/components/demos/pagination-demo"),
};
