...
usage: `import BottomSheet from "@/app/components/ui/bottom-sheet"
...
export function Demo() {
  ...
  return (
    <>
      ...
      <BottomSheet open={open} onClose={() => setOpen(false)} snapPoints={[0.5, 1]}>
...
props: [
  ...
  },
  {
    ...
    type: "() => void",
    default: "—",
    description: "Callback fired when the sheet is dismissed.",
  },
  {
    name: "children",
  ...
  },
  {
    ...
    type: "number[]",
    default: "[0.5, 1]",
    description: "Fractions of viewport height the sheet snaps to.",
  },
  {
    name: "className",
    type: "string",
...
component: () => import("@/app/components/ui/bottom-sheet"),
demo: () => import("@/app/components/demos/bottom-sheet-demo"),
};
