...
usage: `import AnimatedSelect from "@/app/components/ui/animated-select"
...
playground: {
  controls: [
    { name: "placeholder", label: "Placeholder", type: "text", default: "Choose a framework" },
...
component: () => import("@/app/components/ui/animated-select"),
demo: () => import("@/app/components/demos/animated-select-demo"),
};
