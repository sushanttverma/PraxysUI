...
const AlertDialog: React.FC<AlertDialogProps> = ({
  ...
  const handleKeyDown = useCallback(
    (e: KeyboardEvent) => {
      // Alert dialogs should NOT close on Escape — user must choose an action
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <h2
              ...
              className="text-center text-lg font-medium text-chalk"
            >
              {title}
            </h2>
            ...
            {description && (
              <p
                ...
                className="mt-2 text-center text-sm text-blush"
              >
                {description}
              </p>
            )}
